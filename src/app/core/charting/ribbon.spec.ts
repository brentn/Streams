...
import { magnitudeScale, ribbonPoints } from './ribbon';

describe('magnitudeScale', () => {
  it('scales |magnitude| linearly against the window max, capped at maxPx', () => {
    const scale = magnitudeScale(1000, 20);
  ...
  it('returns zero everywhere when the window max is zero', () => {
